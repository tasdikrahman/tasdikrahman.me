...
The perpetrator had been running his malicious program under `/usr/bin` which obviously meant he did gain root access to my server. There was no other I could think of through which he could have placed it under `/usr/bin` otherwise.
